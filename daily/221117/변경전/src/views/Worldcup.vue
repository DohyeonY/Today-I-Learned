...
export default {
  ...
  methods: {
    randomMovieCall() {
      ...
      axios({
        method: 'get',
        url: `${HOST}/api/v1/worldcup/`,
        headers : {
          Authorization: `Token eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyX2lkIjoyLCJ1c2VybmFtZSI6InRlc3QyMiIsImV4cCI6MTY2OTI3ODUwNiwiZW1haWwiOiIiLCJvcmlnX2lhdCI6MTY2ODY3MzcwNn0.ol9_ASIITSrnkMW7yjoB5LAsNeNq9JOln189-p5T9ME`
        }
      })
      .then(response => {
      ...
      // get('http://localhost:8000/api/v1/worldcup/', options)
      // .then(res => {
