...
class get_mgeo :
    ...
    # print(list)
        for link_idx in self.links :
            # print(self.links[link_idx].points)
            for link_point in self.links[link_idx].points:
                point=Point32()
                point.x=link_point[0]
                point.y=link_point[1]
                point.z=link_point[2]
                all_link.points.append(point)
    ...
    def getAllNode(self):
        ...
        for node_idx in self.nodes :
            # print(node_idx)
            # print('nodeidx __________________________')
            point = Point32()
            point.x = self.nodes[node_idx].point[0]
            point.y = self.nodes[node_idx].point[1]
            point.z = self.nodes[node_idx].point[2]
            all_node.points.append(point)
            # print(all_node.points)
