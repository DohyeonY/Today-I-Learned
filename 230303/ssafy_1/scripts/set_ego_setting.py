...
def talker():
    #TODO: (1) publisher 생성
    publisher = rospy.Publisher('ego_setting_msg', MultiEgoSetting, queue_size=10)
    '''
    ...
    ego_setting_msg.global_position_x = [0]
    ego_setting_msg.global_position_y = [0]
    ego_setting_msg.global_position_z = [0]
    ego_setting_msg.global_roll = [0]
    ego_setting_msg.global_pitch = [0]
    ego_setting_msg.global_yaw = [0]
    ego_setting_msg.velocity=[0]
    ego_setting_msg.gear=[0]
    ego_setting_msg.ctrl_mode=[0] 
